    ...
    >
            ...
            <article className='prose mx-auto max-w-2xl' >
                <div className='mx-auto max-w-2xl mb-10' >
                    <div className='flex justify-between' >
                        <div className="border-l border-gray-200 relative pl-3
                        before:content-[''] before:top-0 before:-left-[1px]
                        before:absolute before:h-7 before:w-[1px] before:bg-blue-500">
        ...
        <div className='max-w-4xl mx-auto mt-20 lg:mt-32' >
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5' >
                {projects.filter((a) => project.title !== a.title).map((item, idx) => {
            ...
            <div className='flex justify-center mt-10' >
                ...
                hover:text-blue-500 hover:shadow-2xl' >View All Projects</Link>
