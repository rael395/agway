...
const recentBlogContent = {
    heading: {
        ...
        subTitle: "Our Blog",
        description: "Dive into the heart of business innovation with Agway's blog. Explore recent projects, cutting-edge solutions, and industry trends in consultancy, project management, and general supply. Stay informed and inspired as we share highlights, offering a unique perspective on the evolving business landscape. Join us on this journey, shaping the future of business excellence.",
    }
}
...
const PostCard = ({index, post}) => {
    ...
    return (
        <motion.div 
            ...
            <Image src={post.image} alt={post.title} width={1064} height={644}
            ...
            <div className='p-8'>
                ...
                <p>
                    <Link href={post.url} className='text-[12px] tracking-[2px] uppercase
                    border-b-2 pb-2 inline-block border-blue-500'>
                        Read More
                    </Link>
                </p>
            </div>
